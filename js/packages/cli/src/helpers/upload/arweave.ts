...
export async function arweaveUpload(
  ...
  const link = `https://memecakedev.s3.us-east-2.amazonaws.com/dummy/CryptoApe/${index}.json`;
  const imageLink = `https://memecakedev.s3.us-east-2.amazonaws.com/dummy/CryptoApe/${index}.png`;;
